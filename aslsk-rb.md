...
![Пример преимущества высоты и LOS на холме](file:///hill-ex.png)
...
![Пример фазы Сбора](file:///Rally-ex.png)
...
![Интенсивный Огонь](file:///Intensive_F.png)
...
![место попадания](file:///Vehicle_sides.png)
...
![Пример To Hit](file:///To_Hit-ex.png)
...
![Пример процедуры на попадание 2](file:///To_Hit-ex2.png)
...
![фишка PrepFire](file:///Prep_F.png)
