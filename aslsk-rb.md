...
используется при определении LOS. Половинки гексов вдоль края
...
также блокировать LOS или создавать на ней помехи, а также
...
дюйма держится дольше и ставится артиллерийским вооружением в начале PFPh или DFPh при
...
рассеянного дыма. Дым представляет помеху на LOS, присущую всему гексу; любой
...
вооружения (MA), давление на грунт, размер цели, ROF (если есть), фактор
...
запасы особых боеприпасов (см. [Особые типы боеприпасов и показатели истощения]).
...
(см. [Процесс попадания]); штрафы: TH DRM +2, показатель B# снижен на 2
([Отказ артиллерийского вооружения]).

Interdiction (перехват)
: вызывает NMC сломленного подразделения, бегущего (не переползающего) через
...
был уничтожен лидер с более высоким боевым духом (см. [Результаты огневых
атак]).
...
кроме имеющих лафеты, обеспечивающие круговое вращение (см.
...
: каждая сторона может иметь в гексе до трех эквивалетнов MMC плюс до четырех
...
при одноместной башне или результате MC, равным 12 (см. [Эффекты на AFV]); также
приводит к отзыву.
...
первым). dr, равный 6, уничтожает его. Экипаж боеспособной техники может
попытаться починить отказавший MG или MA; dr, равный 1, чинит вооружение, а dr,
равный 6, уничтожает его.
...
лидерства, а любая попытка самостоятельного сбора штрафуется DRM +1.
...
не существует штрафа, за исключением DR 12 без учета модификаторов, в случае
чего подразделение несет потери. Подразделение не может делать попытку сбора
больше одного раза за фазу; однако боеспособный лидер может пытаться собрать
каждое подразделение в одной стопке с ним.
...
свой маркер DM, если только оно - не в лесу или здании.

### Пример RPh советской стороны

![Пример RPh советской стороны](./Rally-ex.png)

Сломленная 5-2-7 в Q6 проводит попытку самостоятельного сбора. Оно должно
добавить к DR +1 за попытку самостоятельного сбора, но вычесть 1 за нахождение в
здании. На кубиках - 7, DRM компенсируют друг друга, 5-2-7 успешно собирается и
переворачивается на боеспособную сторону.

После этого лидер пытается провести сбор двух подразделений. Сломленная 5-2-7
должна добавить +4 к DR из-за маркера DM. Применяются DRM: -1 лидерства и -1
здания. Сломленная 4-4-7 не имеет DM и поэтому не добавляет +4 к DR. Суммарный
DRM для 5-2-7 равен +2, а для 4-4-7 - -2. За 5-2-7 на кубиках выпадает 6; после
модификации +2 итог - 8. Так как 8 больше, чем 7 (показателя боевого духа
5-2-7), то подразделение не собирается. За 4-4-7 на кубиках выпадает 9, после
модификации -2 итог - 7. Так как это - не больше показателя боевого духа
подразделения, то 4-4-7 успешно собирается и переворачивается на боеспособную
сторону.
