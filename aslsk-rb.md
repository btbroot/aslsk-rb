...
(FT), подрывные заряды (DC), легкие минометы и легкое противотанковое
...
**DC:** подрывной заряд ([4.3 Подрывной заряд (DC)]).
...
**X#:** число поломки огнемета (FT), подрывного заряда (DC), базуки (BAZ) или
